...
from basket.views import BasketsView, BasketItemsView, BasketCheckoutView

app_name = 'baskets'

urlpatterns = [
    re_path(r'^(?P<basket_id>[a-f0-9\-]+)/checkout$', BasketCheckoutView.as_view(), name='basketItems'),
