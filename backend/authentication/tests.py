...
class Registration(TestCase):
    ...
    def test_user_creation(self):
        ...
        """
        user = User.objects.create_user('cristinagarbuz@gmail.com', 'cristinagarbuz@gmail.com', 'private2487')

        self.assertEqual(user.username, 'cristinagarbuz@gmail.com')
        self.assertEqual(user.email, 'cristinagarbuz@gmail.com')
